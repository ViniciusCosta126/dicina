...
export default function EditorComponent({ attributes, setAttributes }) {
	...
	const { variant, bgColor, bgColorDegrade, bgColorDegradeDesk, bgImageMobile, bgImageDesk, isHero, marginM, marginD } =
		attributes;
	...
	return (
		<>
			...
			<div className={`memoirs ${variant} wp-editor memoirs-${randomComponentId}`}>
				<picture className={`memoirs-background`}>
					<source srcset={bgImageDesk.src} media="(min-width: 768px)" />
					<img src={bgImageMobile.src} alt={bgImageMobile.alt} />

					<ExternalLink className="external-link" href="/wp-admin/nav-menus.php">
						Configure as memórias
					</ExternalLink>
				</picture>

				<div className="container">
					<div className={`memoirs-content ${isHero ? 'is-hero' : ''}`}>
						<InnerBlocks
							template={[
								[
									'il/typography',
								...
								[
									...
									[
										[
											'il/typography',
											{
												content: 'Selecione um dia e mês para acessar uma memória de Ayrton Senna',
												tag: 'p',
												manualSizes: true,
												manualSizeM: 20,
												manualSizeD: 26,

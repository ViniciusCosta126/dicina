    ...
    while ( have_rows('conteudo') ) : the_row();
		...
		<?php elseif( get_row_layout() == 'posts_relacionado' ): ?>
			<section class="content">
				<?php
					if( have_rows('postagens') ):
					    while ( have_rows('postagens') ) : the_row();
						        ...
						        <article class="postagens">
						        	...
						        	<?php endif ?>
						           	<div class="postagens-conteudo">
										...
										<?php $vez = 1; while ( have_rows('conteudo', $post_object->ID)) : the_row(); ?>
												<?php if( get_row_layout() == 'texto' && $vez == 1): ?>
												<div class="postagens-texto">
													<?php $texto = get_sub_field('texto'); ?>
													<p><?php echo mkt_truncate($texto, 200, false, false); ?></p>
												</div>
											<?php $vez++; endif; ?>
										<?php  endwhile; ?>
